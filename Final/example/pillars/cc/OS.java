...
/**
 * Pillar(柱を描くクラス)を継承し、
 * 教科課程の一つであるOS(オペレーティングシステム)を描くクラス
 */
public class OS extends Pillar implements ComputingCurricula
{
    /**
     * このクラスのコンストラクタ。
     * 自身の親のインスタンスを生成する。
    ...
    public void setCylinder()
    {
        ...
        super.setCylinder(100, 300, 170, 150, new Font("Arial", Font.PLAIN, 24),
                        "OS", ySubstractionList, heightSubstractionList);
        return;
    }
    ...
    public void setSubject()
    {
        ...
        subjects.add("オペレーティングシステム：荻原　剛志");
